		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgc,
					description: 'Private Bot by Defan',
					previewType: "PHOTO",
					thumbnail: await (await fetch(urls)).buffer(),
					sourceUrl: "https://github.com/Defan11",					
				}
			}
		}
		global.fakeig = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            mediaUrl: "https://github.com/Defan11",
            mediaType: "VIDEO",
            description: "https://github.com/Defan11", 
            title: 'Private Bot by Defan',
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
    }
       ...
       key: {
           ...
           "message": {
               "groupInviteMessage": {
                   ...
                   "inviteCode": "null",
                   "groupName": "Friends Mizuhara-Mdོ", 
                   "caption": wm, 
                   'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')
               }
           }
